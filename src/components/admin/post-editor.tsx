...
function SubmitButton() {
	...
	return (
		<button
			type="submit"
			disabled={pending}
			className="border border-[var(--color-border)] bg-[var(--color-primary-fill)] px-6 py-3 text-sm font-bold text-[var(--color-on-primary)] rounded-[var(--radius-full)] shadow-[var(--elev-1)] transition-colors hover:bg-[var(--color-primary-hover)] disabled:opacity-50"
		>
...
export function PostEditor({
	...
	return (
		<form action={savePost} className="space-y-4 rounded-[var(--radius-lg)] border border-[var(--color-border)] bg-[var(--color-surface)] p-6 shadow-[var(--elev-1)]">
